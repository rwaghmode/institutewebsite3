...
.owl-carousel .owl-wrapper{-webkit-backface-visibility:hidden;
	...
	.owl-carousel .owl-item{min-height:1px;float:left;-webkit-backface-visibility:hidden;
		...
		.owl-prev{cursor:pointer;cursor:hand;
			...
			.owl-item{-ms-touch-action:none;touch-action:none;-webkit-user-select:none;
				...
				.owl-carousel .animated{-webkit-animation-duration:1s;animation-duration:1s;
					...
					.owl-carousel .owl-video-play-icon{position:absolute;height:80px;width:80px;left:50%;top:50%;margin-left:-40px;
						margin-top:-40px;background:url(owl.video.play.png) no-repeat;cursor:pointer;z-index:1;
